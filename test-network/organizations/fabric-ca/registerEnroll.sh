...
function createOrg4() {
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:10054 --caname ca-org4 --tls.certfiles "${PWD}/organizations/fabric-ca/org4/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the peer0 msp"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:10054 --caname ca-org4 -M "${PWD}/organizations/peerOrganizations/org4.example.com/peers/peer0.org4.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org4/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:10054 --caname ca-org4 -M "${PWD}/organizations/peerOrganizations/org4.example.com/peers/peer0.org4.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org4.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/org4/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the user msp"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:10054 --caname ca-org4 -M "${PWD}/organizations/peerOrganizations/org4.example.com/users/User1@org4.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org4/ca-cert.pem"
  { set +x; } 2>/dev/null
  ...
  infoln "Generating the org admin msp"
  set -x
  fabric-ca-client enroll -u https://org4admin:org4adminpw@localhost:10054 --caname ca-org4 -M "${PWD}/organizations/peerOrganizations/org4.example.com/users/Admin@org4.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org4/ca-cert.pem"
  { set +x; } 2>/dev/null
...
function createOrg() {
  org=$1
  org_port=$((7054 + 100 * (org - 1))) 

  infoln "Enrolling the CA admin for Org$org"
  ...
  set -x
  fabric-ca-client enroll -u https://admin:adminpw@localhost:$org_port
 --caname ca-org${org} --tls.certfiles "${PWD}/organizations/fabric-ca/org${org}/ca-cert.pem"
  { set +x; } 2>/dev/null

  echo "NodeOUs:
  Enable: true
  ClientOUIdentifier:
    Certificate: cacerts/localhost-${org_port}-ca-org${org}.pem
    OrganizationalUnitIdentifier: client
  PeerOUIdentifier:
    Certificate: cacerts/localhost-${org_port}-ca-org${org}.pem
    OrganizationalUnitIdentifier: peer
  ...
  cp "${PWD}/organizations/fabric-ca/org${org}/ca-cert.pem" "${PWD}/organizations/peerOrganizations/org${org}.example.com/msp/tlscacerts/ca.crt"

  mkdir -p "${PWD}/organizations/peerOrganizations/org${org}.example.com/tlsca"
  cp "${PWD}/organizations/fabric-ca/org${org}/ca-cert.pem"
 "${PWD}/organizations/peerOrganizations/org${org}.example.com/tlsca/tlsca.org${org}.example.com-cert.pem"

  mkdir -p "${PWD}/organizations/peerOrganizations/org${org}.example.com/ca"
  cp "${PWD}/organizations/fabric-ca/org${org}/ca-cert.pem"
 "${PWD}/organizations/peerOrganizations/org${org}.example.com/ca/ca.org${org}.example.com-cert.pem"

  infoln "Registering peer0 for Org$org"
  set -x
  fabric-ca-client register --caname ca-org${org} --id.name peer0 --id.secret peer0pw --id.type peer --tls.certfiles "${PWD}/organizations/fabric-ca/org${org}/ca-cert.pem"

  { set +x; } 2>/dev/null

  infoln "Registering user for Org$org"
  set -x
  fabric-ca-client register --caname ca-org${org} --id.name user1 --id.secret user1pw --id.type client --tls.certfiles "${PWD}/organizations/fabric-ca/org${org}/ca-cert.pem"

  { set +x; } 2>/dev/null

  infoln "Registering the org admin for Org$org"
  set -x
  fabric-ca-client register --caname ca-org${org} --id.name org${org}admin --id.secret org${org}adminpw --id.type admin --tls.certfiles "${PWD}/organizations/fabric-ca/org${org}/ca-cert.pem"

  { set +x; } 2>/dev/null
  
  infoln "Generating the peer0 msp for Org$org"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:$org_port --caname ca-org${org} -M "${PWD}/organizations/peerOrganizations/org${org}.example.com/peers/peer0.org${org}.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org${org}/ca-cert.pem"
  { set +x; } 2>/dev/null
 ...
 for Org$org"
  set -x
  fabric-ca-client enroll -u https://peer0:peer0pw@localhost:$org_port --caname ca-org${org} -M "${PWD}/organizations/peerOrganizations/org${org}.example.com/peers/peer0.org${org}.example.com/tls" --enrollment.profile tls --csr.hosts peer0.org${org}.example.com --csr.hosts localhost --tls.certfiles "${PWD}/organizations/fabric-ca/org${org}/ca-cert.pem"

  { set +x; } 2>/dev/null


  # Copy the tls CA cert, server cert, server keystore to well known file names in the peer's tls directory that are referenced by peer startup config
  cp "${PWD}/organizations/peerOrganizations/org${org}.example.com/peers/peer0.org${org}.example.com/tls/tlscacerts/"*
 "${PWD}/organizations/peerOrganizations/org${org}.example.com/peers/peer0.org${org}.example.com/tls/ca.crt"
  ...
  infoln "Generating the user msp for Org$org"
  set -x
  fabric-ca-client enroll -u https://user1:user1pw@localhost:$org_port --caname ca-org${org} -M "${PWD}/organizations/peerOrganizations/org${org}.example.com/users/User1@org${org}.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org${org}/ca-cert.pem"
  { set +x; } 2>/dev/null
 ...
 for Org$org"
  set -x
  fabric-ca-client enroll -u https://org${org}admin:org${org}adminpw@localhost:$org_port --caname ca-org${org} -M "${PWD}/organizations/peerOrganizations/org${org}.example.com/users/Admin@org${org}.example.com/msp" --tls.certfiles "${PWD}/organizations/fabric-ca/org${org}/ca-cert.pem"
  { set +x; } 2>/dev/null
